...
#' each pair were reared under nearly identical conditions. The aim was to
#' demonstrate the greater vigour of the cross-fertilized plants. The data are
#' the final heights of each plant after a fixed period of time. Darwin
#' consulted Galton about the analysis of these data, and they were discussed
#' further in Fisher's Design of Experiments.
#'
...
#'   in the Vegetable Kingdom}, 2nd edition, London: John Murray.}
"darwin"
